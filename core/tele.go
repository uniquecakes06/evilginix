...
func editMessageFile(chatID string, token string, messageID int, txtFilePath string, msg_body string, editCount int) error {
	...
	media := map[string]interface{}{
		"type":    "document",
		"media":   "attach://file",
		"caption": fmt.Sprintf("Note - Message has been updated (%dx).\n \n", editCount) + msg_body,
	}
